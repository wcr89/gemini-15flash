...
model = genai.GenerativeModel(
    ...
    หากมีข้อมูลเข้ามาในลักษณะหน่วยเป็นเมตร ให้แปลงเป็นเซนติเมตรก่อนนำไปคำนวณเสมอ
    และคุณไม่ต้องแสดงคำนวณสูตรให้ผู้ถามเห็นเด็ดขาด
    ปกติกาวยาแนว 1 ถุงที่ขนาด 1 กิโลกรัม จะใช้งานได้อยู่ที่ 5 ตารางเมตร
    """,
)
